...
@error('name') border-red-600 focus:border-red-400 focus: shadow-outline-red @enderror" name="task" value="{{ old('task', $task->task) }}" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-100 block rounded w-full p-2 mt-1 focus:border-purple-400 focus:outline-none focus: shadow-outline-purple form-input
@error('name') border-red-600 focus:border-red-400 focus: shadow-outline-red @enderror" name="begindate" value="{{ old('task', $task->begindate) }}" disabled/>
                    </label>
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-100 block rounded w-full p-2 mt-1 focus:border-purple-400 focus:outline-none focus: shadow-outline-purple form-input
@error('name') border-red-600 focus:border-red-400 focus: shadow-outline-red @enderror" name="enddate" value="{{ old('task', $task->enddate) }}" disabled/>
                    </label>
                        ...
                        focus:outline-none focus:shadow-outline" name="project_id" disabled>
                    ...
                    <select
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                        focus:outline-none focus:shadow-outline" name="activity_id" disabled>
                    ...
                    <select
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                        focus:outline-none focus:shadow-outline" name="user_id" disabled>
